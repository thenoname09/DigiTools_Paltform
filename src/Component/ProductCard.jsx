...
const ProductCard = ({product}) => {
    ...
    return (
        <div>
                    ...
                    <div className="card w-96 bg-base-100 shadow-sm border border-amber-200">
  <div className="card-body space-y-2">
    ...
    <div className=" rounded-full max-w-15 p-3  border border-stone-300">
    ...
    <div className="text-[#627382FF] font-medium text-sm">
     {
